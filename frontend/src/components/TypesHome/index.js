    ...
    <div className="types__container">
      ...
      <div className="types__homes-container">
        <div className="homes-card">
          <Link
            to={{ pathname: "/homes", state: { title: "Outdoor gateways" } }}
          >
            <img
        ...
        <div className="homes-card">
          <Link to={{ pathname: "/homes", state: { title: "Unique stays" } }}>
            <img
        ...
        <div className="homes-card">
          <Link to={{ pathname: "/homes", state: { title: "Entire homes" } }}>
            <img
        ...
        <div className="homes-card">
          <Link to={{ pathname: "/homes", state: { title: "Pets allowed" } }}>
            <img
