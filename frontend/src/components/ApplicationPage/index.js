...
export default function ApplicationPage() {
  return (
    <div className="application_page__container">
      <div className="application_page__leftside">
        <div className="move-to-tr">
          <svg
            viewBox="0 0 32 32"
        ...
        <h2 className="application-title">
          Fill out a hosting
          <br /> application to become a seller.
        </h2>
      </div>
      <div className="application_page__rightside">
        <ApplicationForm />
      </div>
    </div>
  );
